...
jQuery("#autocomplete").autocomplete({
  ...
  minLength: 3
    ...
    jQuery('li.active:even').css('background-color', '#fbfbfb');
    ...
    if (item.c){
      ...
      if(item.fp!=item.op){
        sSale="<span style='background-color:#65984d;color:#ffffff;padding:3px;'>&nbsp;"+sF$.fnFormatNumber(((item.op-item.fp)/item.op)*100)+"%&nbsp;off&nbsp;</span>&nbsp;&nbsp;";}
      else{
        sSale=""
      }
